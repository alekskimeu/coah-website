  ...
  return (
    <Layout>
      ...
      <section className="py-[5rem]">
        <div className="container mx-auto bg-[#17403F] rounded-2xl py-[5rem] px-[3rem] flex flex-col gap-15 lg:gap-10">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14">
            <Post
              ...
              content="This is the second part of the SMM starter pack series of articles. If you made it this far, you must be... "
              date="2 days ago"
            />
            <Post
              image={image}
