        ...
        <Layout>
            <section className="pt-[3rem] pb-[5rem]">
                <div className="post-container mx-auto">
                    <Image height="450" width="100" src={post.coverImage} className="w-full h-[450px] object-cover rounded-t-xl mb-6" />

                    <div className="flex justify-between items-center">
                        <div>
                            <h1 className="font-semibold text-lg text-[#283891]">{post.title}</h1>
